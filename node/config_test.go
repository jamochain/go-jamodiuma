...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gjam.ipc", false, filepath.Join(os.TempDir(), "gjam.ipc")},
		{"data", "gjam.ipc", false, "data/gjam.ipc"},
		{"data", "./gjam.ipc", false, "./gjam.ipc"},
		{"data", "/gjam.ipc", false, "/gjam.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gjam.ipc", true, `\\.\pipe\gjam.ipc`},
		{"data", "gjam.ipc", true, `\\.\pipe\gjam.ipc`},
		{"data", `\\.\pipe\gjam.ipc`, true, `\\.\pipe\gjam.ipc`},
	}
