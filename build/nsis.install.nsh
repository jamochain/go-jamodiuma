Name "gjam ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/jamochain/go-jamodiuma/issues"
!define UPDATEURL "https://github.com/jamochain/go-jamodiuma/releases"
!define ABOUTURL "https://github.com/jamochain/go-jamodiuma#ethereum-go"
...
# Install gjam binary
Section "Gjam" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gjam}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gjam.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gjam.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gjam incoming peers (TCP:35290)"
  SimpleFC::AdvRemoveRule "Gjam outgoing peers (TCP:35290)"
  SimpleFC::AdvRemoveRule "Gjam UDP discovery (UDP:35290)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gjam incoming peers (TCP:35290)" ""  6 1 1 2147483647 1 "$INSTDIR\gjam.exe" "" "" "Ethereum" 35290 "" "" ""
  SimpleFC::AdvAddRule "Gjam outgoing peers (TCP:35290)" ""  6 2 1 2147483647 1 "$INSTDIR\gjam.exe" "" "" "Ethereum" "" 35290 "" ""
  SimpleFC::AdvAddRule "Gjam UDP discovery (UDP:35290)" "" 17 2 1 2147483647 1 "$INSTDIR\gjam.exe" "" "" "Ethereum" "" 35290 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gjam.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gjam.ipc"
